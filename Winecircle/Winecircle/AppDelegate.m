...
- (void)buildMainTabBar
{
    ...
    [home.tabBarItem setImage:[UIImage imageNamed:@"sy.png"]];
    home.title = @"首页";
    
    CircleVC *circle = [[CircleVC alloc] init];
    UINavigationController *nav2 = [[UINavigationController alloc] initWithRootViewController:circle];
    [circle.tabBarItem setImage:[UIImage imageNamed:@"qz.png"]];
    circle.title = @"圈子";
    ...
    [personal.tabBarItem setImage:[UIImage imageNamed:@"wd.png"]];
    personal.title = @"我的";
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.sunday.CoreDataPractice" in the application's documents directory.
